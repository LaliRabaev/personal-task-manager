...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createTaskElement(task) {
        ...
        taskElement.innerHTML = `
            ...
            document.querySelectorAll('[id^="select-box"]').forEach(selectBox => {
                const selectButton = selectBox.querySelector('.brd');
                const optionsViewButton = selectBox.querySelector('[id^="options-view-button"]');
                const options = selectBox.querySelector('.options');
                const selectedValue = selectBox.querySelector('[id^="selected-value"] span');
                
                // Apply initial selected color
                const initialColor = selectButton.dataset.selectedColor;
                selectButton.style.backgroundColor = initialColor;
                ...
                options.querySelectorAll('.option').forEach(option => {
                    option.addEventListener('click', function() {
                        ...
                        selectButton.style.backgroundColor = color;
